...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.DurationVar(&o.config.IPVS.TCPActiveTimeout.Duration, "ipvs-tcp-active-timeout", o.config.IPVS.TCPActiveTimeout.Duration, "Set TCP timeout for active IPVS connections (established)")
	fs.DurationVar(&o.config.IPVS.TCPInActiveTimeout.Duration, "ipvs-tcp-inactive-timeout", o.config.IPVS.TCPInActiveTimeout.Duration, "Set TCP timeout for inactive IPVS connections (FIN received)")
	fs.DurationVar(&o.config.IPVS.UDPTimeout.Duration, "ipvs-udp-timeout", o.config.IPVS.UDPTimeout.Duration, "Set UDP timeout for active IPVS connections")
